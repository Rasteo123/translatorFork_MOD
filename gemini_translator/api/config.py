...
def _load_short_basic_translation_prompt():
    if _SHORT_BASIC_TRANSLATION_PROMPT_FILE.exists():
        try:
            with open(_SHORT_BASIC_TRANSLATION_PROMPT_FILE, 'r', encoding='utf-8') as f:
                return f.read().strip()
        except Exception:
            return _DEFAULT_BASIC_TRANSLATION_PROMPT_TEXT
    return _DEFAULT_BASIC_TRANSLATION_PROMPT_TEXT
